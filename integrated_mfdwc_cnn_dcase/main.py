...
def train():
    ...
    # --- Data loading ---
    src_devices_mixup , target_devices_mixup, label_mix_up , train_src_df, train_tgt_df, test_src_df, test_tgt_df  = data_split(src_device , tgt_device)
    ...
    # ADD: Initialize MFDWC feature extractor
    ...
    for epoch in range(1, NUM_EPOCHS + 1):
        ...
        for batch_idx, (src_data, tgt_data) in enumerate(create_combined_loader(src_loader, tgt_loader)):
            ...
            with torch.no_grad():  # No gradients for MFDWC if frozen
